...
public class example03 {
    ...
    {
        System.out.println("Бъет ли ферзь фигуру?");
        System.out.println("   1 2 3 4 5 6 7 8  \n   ---------------  \n8 |* * * * * * * *| 8");
        System.out.println("7 |* * * * * * * *| 7\n6 |* * * * * * * *| 6\n5 |* * * * * * * *| 5");
        System.out.println("4 |* * * * * * * *| 4\n3 |* * * * * * * *| 3\n2 |* * * * * * * *| 2");
        System.out.println("1 |* * * * * * * *| 1\n   ---------------  \n   1 2 3 4 5 6 7 8  ");
        System.out.println("Введите координату 1 для ферзя");
        short x1 = in.nextShort();
        System.out.println("Введите координату 2 для ферзя");
        ...
        in.close();
        if ((x1-y1)==(x2-y2) || (x1+y1)==(x2+y2) || (x1 == x2) || (y1 == y2)) System.out.println("YES");
